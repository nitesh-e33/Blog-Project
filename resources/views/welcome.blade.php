...
<body>
    <header>
        <div class="header-button">
            @if(Session::has('customer_id'))
               ...
               <a href="/my-account" class="button">My Profile</a>
            @else
    ...
    <main>
        ...
        <div class="article">
           <a href="{{ url('/blog/'.$blog['slug']) }}"><img src="{{ asset('uploads/customers/'.$blog['image']) }}" alt="Sample Image" width="200" height="150" style="float: left; margin-right: 20px;"></a> 
...
.w-5{
  ...
  <!-- <div class="article">
            <img src="https://cdni.autocarindia.com/utils/imageresizer.ashx?n=https://cms.haymarketindia.net/model/uploads/modelimages/BMW-2-Series-Gran-Coupe-271220221147.jpg" alt="Sample Image" width="200" height="150" style="float: left; margin-right: 20px;">
            <h2>Latest Cars in India</h2>
        ...
        <section class="article">
            <img src="https://5.imimg.com/data5/SELLER/Default/2021/7/LR/FU/MQ/3027728/yamaha-fzs-fi-new-bike-500x500.jpg" alt="Sample Image" width="200" height="150" style="float: left; margin-right: 20px;">
            <h2>New Bikes in India 2023</h2>
            <p class="meta">Posted on September 17, 2023 by John Doe</p>
        ...
        <section class="article">
            <img src="https://m.media-amazon.com/images/I/71TZCUBu+ML._AC_UF1000,1000_QL80_.jpg" alt="Sample Image" width="200" height="150" style="float: left; margin-right: 20px;">
            <h2>Baybee Robicun Battery Operated Car</h2>
            <p class="meta">Posted on September 17, 2023 by John Doe</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam in magna at ex feugiat vehicula at a erat.</p>
            <a href="#">Read More</a>
        </section>
        <section class="article">
            <img src="https://gemopai.com/frontend/img/astrid/Astrid-Lite-Electric-Scooter-Red-Color.jpeg" alt="Sample Image" width="200" height="150" style="float: left; margin-right: 20px;">            
            <h2>Impact of Electric Vehicles on the Environment</h2>
            <p class="meta">Posted on September 17, 2023 by John Doe</p>
